...
def gGTFS(ruta_EZ0, puntos, G, root_dir, n_trips = 6, freq = 10, start_hour = '8:00'):
    ...
    directory = root_dir + 'assets/data/input_data_MCM/GTFS_feeds/routes_EZ_companies/'
    ...
    network = pdn.network.Network.from_hdf5(root_dir + 'assets/data/input_data_MCM/' + f'networks/drive_net.h5')
