...
class MiscFunctions:
    ...
    def run_MCM(trips_ez, root_Dir, Transh, routeOptDone, co2km_car=0.15, co2km_eCar= 0.01081, co2km_bus=1.3, co2km_train=0.049, bus_train_ratio=0.8, NremDays=0, NremWork=0, NeCar=0, CowCoords=[], CowDays=0):
        ...
        model_dir = root_dir + 'components/models/'
        ...
        prediction=prediction.predict(trips_ez, trips_ez_base, routeOptDone, co2km_car, co2km_eCar, co2km_bus, co2km_train, bus_train_ratio, NeCar, model_dir)  
